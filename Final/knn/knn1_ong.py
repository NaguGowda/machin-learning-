...
def load_all_Dataset(filename, atestSet=[]):
	lines1 = csv.reader(open(filename, "r"))
	adataset1 = list(lines1)
	adatasetd1 = list(lines1)
	adatasetd2 = list(lines1)
		
	for x in range(len(adataset1)):
	        for y in range(22):
	            #adataset1[x][y] = float(adataset1[x][y])	
	if y<5:
		print(y)	        
	atestSet.append(adataset1[x])	
...
def main():
	...
	testSet_d1=[]
	testSet_d2=[]
	load_all_Dataset('all_test.csv', atestSet)
	print ('Test set: ', repr(len(atestSet)))
	print ('Test: ',atestSet)
